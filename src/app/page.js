export default function Home() {
  return (
    <div className="min-h-[400vh] border-50 border-[#566459] p-8 ">
      ...
      {/* Image + QR Code Block */}
      <div className="w-full max-w-400 bg-[#0e2010] rounded-xl p-6 flex flex-col md:flex-row items-center justify-center gap-6 ml-4 h-200 -mt-78">
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-6 text-xl text-[#0e2010] ml-200">
